...
import {
  ...
  type AddFileBackendConfigEndpointParams,
  type AddFileBackendConfigEndpointResult,
  type AddFileBackendMountEndpointParams,
  type AddFileBackendMountEndpointResult,
  type CountFileBackendConfigsEndpointParams,
  type CountFileBackendMountsEndpointParams,
  type DeleteFileBackendConfigEndpointParams,
  type DeleteFileBackendMountEndpointParams,
  type GetFileBackendConfigEndpointParams,
  type GetFileBackendConfigEndpointResult,
  type GetFileBackendConfigsEndpointParams,
  type GetFileBackendConfigsEndpointResult,
  type GetFileBackendMountEndpointParams,
  type GetFileBackendMountEndpointResult,
  type GetFileBackendMountsEndpointParams,
  type GetFileBackendMountsEndpointResult,
  type ResolveFileBackendMountsEndpointParams,
  type ResolveFileBackendMountsEndpointResult,
  type UpdateFileBackendConfigEndpointParams,
  type UpdateFileBackendConfigEndpointResult,
  type UpdateFileBackendMountEndpointParams,
  type UpdateFileBackendMountEndpointResult,
...
export class FileBackendsEndpoints extends AbstractSdkEndpoints {
  /**
